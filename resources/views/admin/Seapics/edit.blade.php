...
@section('content')
 ...
 <body>
  <form action="{{route(admin.seapics.update,$d->id)}}" method="POST">
   @csrf
   @method('PUT')
  <div class="container">
  ...
  <option value="1">Sta. Ana</option>
  <option value="2">Gonzaga</option>
  <option value="3">Buguey</option>
</select>
  </div>
  <div class="col">
    <br>
...
<div class="row mb-1 mt-1">
    ...
    <input type="submit" value="Update Now" name="save" class="btn btn-primary">
