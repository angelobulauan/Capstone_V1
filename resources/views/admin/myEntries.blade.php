...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 p-1"><i
                                            class="fa fa-info-circle mr-2 text-primary"></i>Description:
                                        {{ $d->description }}</div>
                                    <div class="col-sm-6 p-1"><i class="fa fa-map-marker mr-2 text-warning"></i>Location:
                                        {{ $d->location }}</div>
                                    <div class="col-sm-6 p-1"><i class="fa fa-map-pin mr-2"></i>Abundance:
                                        {{ $d->abundance }}</div>
                                    ...
                                    <div class="row mt-0">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end align-items-center">
                                            ...
                                            <div class="p-1">
                                                <form action="{{ route('delete.ko', ['d_id' => $d->id]) }}" method="post" class="selec">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal fade" id="imageSelectionModal" tabindex="-1" aria-labelledby="imageSelectionModalLabel"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="imageOptions">
                    ...
                    @foreach ($selectphoto as $photo)
                        <form action="{{ route('admin.update-photo', ['id' => $d->id, 'photo' => $photo->id])}}" class="update-photo-form"
